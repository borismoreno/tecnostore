...
import { R as ROUTE_TYPE_HEADER, p as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, q as ActionNotFoundError, v as clientAddressSymbol, w as LocalsNotAnObject, x as REROUTABLE_STATUS_CODES, y as responseSentSymbol } from './astro/server_CCyU3dUX.mjs';
import { fileExtension, joinPaths, slash, prependForwardSlash, removeTrailingForwardSlash, appendForwardSlash as appendForwardSlash$1, collapseDuplicateTrailingSlashes, hasFileExtension } from '@astrojs/internal-helpers/path';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_DrmMkbr0.mjs';
import { D as DEFAULT_404_ROUTE, e as default404Instance, f as ensure404Route } from './astro-designed-error-pages_fPkp4yy4.mjs';
